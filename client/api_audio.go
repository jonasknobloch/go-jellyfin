...
// GetAudioStreamOpts Optional parameters for the method 'GetAudioStream'
type GetAudioStreamOpts struct {
 ...
 * @param optional nil or *GetAudioStreamOpts - Optional Parameters:
...
@return *os.File
*/
func (a *AudioApiService) GetAudioStream(ctx _context.Context, itemId string, container string, localVarOptionals *GetAudioStreamOpts) (*os.File, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Audio/{itemId}/stream"
...
// GetAudioStreamByContainerOpts Optional parameters for the method 'GetAudioStreamByContainer'
type GetAudioStreamByContainerOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param itemId The item id.
 * @param container The audio container.
 * @param optional nil or *GetAudioStreamByContainerOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *AudioApiService) GetAudioStreamByContainer(ctx _context.Context, itemId string, container string, localVarOptionals *GetAudioStreamByContainerOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Audio/{itemId}/stream.{container}"
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", _neturl.QueryEscape(parameterToString(itemId, "")) , -1)
...
// HeadAudioStreamOpts Optional parameters for the method 'HeadAudioStream'
type HeadAudioStreamOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param itemId The item id.
 * @param container The audio container.
 * @param optional nil or *HeadAudioStreamOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *AudioApiService) HeadAudioStream(ctx _context.Context, itemId string, container string, localVarOptionals *HeadAudioStreamOpts) (*os.File, *_nethttp.Response, error) {
	var (
...
// HeadAudioStreamByContainerOpts Optional parameters for the method 'HeadAudioStreamByContainer'
type HeadAudioStreamByContainerOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param itemId The item id.
 * @param container The audio container.
 * @param optional nil or *HeadAudioStreamByContainerOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *AudioApiService) HeadAudioStreamByContainer(ctx _context.Context, itemId string, container string, localVarOptionals *HeadAudioStreamByContainerOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodHead
		localVarPostBody     interface{}
		localVarFormFileName string
