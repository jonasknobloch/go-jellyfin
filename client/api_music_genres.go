...
// GetMusicGenreOpts Optional parameters for the method 'GetMusicGenre'
type GetMusicGenreOpts struct {
 ...
 * @param optional nil or *GetMusicGenreOpts - Optional Parameters:
 * @param "UserId" (optional.Interface of string) -  Optional. Filter by user id, and attach user data.
@return BaseItemDto
*/
func (a *MusicGenresApiService) GetMusicGenre(ctx _context.Context, genreName string, localVarOptionals *GetMusicGenreOpts) (BaseItemDto, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/MusicGenres/{genreName}"
	localVarPath = strings.Replace(localVarPath, "{"+"genreName"+"}", _neturl.QueryEscape(parameterToString(genreName, "")) , -1)
...
// GetMusicGenresOpts Optional parameters for the method 'GetMusicGenres'
type GetMusicGenresOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetMusicGenresOpts - Optional Parameters:
 ...
 * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered in based on item type. This allows multiple, comma delimited.
 ...
 * @param "EnableTotalRecordCount" (optional.Bool) -  Optional. Include total record count.
@return BaseItemDtoQueryResult
*/
func (a *MusicGenresApiService) GetMusicGenres(ctx _context.Context, localVarOptionals *GetMusicGenresOpts) (BaseItemDtoQueryResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
