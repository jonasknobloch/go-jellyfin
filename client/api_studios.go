...
// GetStudioOpts Optional parameters for the method 'GetStudio'
type GetStudioOpts struct {
 ...
 * @param optional nil or *GetStudioOpts - Optional Parameters:
 * @param "UserId" (optional.Interface of string) -  Optional. Filter by user id, and attach user data.
@return BaseItemDto
*/
func (a *StudiosApiService) GetStudio(ctx _context.Context, name string, localVarOptionals *GetStudioOpts) (BaseItemDto, *_nethttp.Response, error) {
	var (
...
// GetStudiosOpts Optional parameters for the method 'GetStudios'
type GetStudiosOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetStudiosOpts - Optional Parameters:
...
*/
func (a *StudiosApiService) GetStudios(ctx _context.Context, localVarOptionals *GetStudiosOpts) (BaseItemDtoQueryResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
