...
// GetGenreOpts Optional parameters for the method 'GetGenre'
type GetGenreOpts struct {
 ...
 * @param optional nil or *GetGenreOpts - Optional Parameters:
 * @param "UserId" (optional.Interface of string) -  The user id.
@return BaseItemDto
*/
func (a *GenresApiService) GetGenre(ctx _context.Context, genreName string, localVarOptionals *GetGenreOpts) (BaseItemDto, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Genres/{genreName}"
...
// GetGenresOpts Optional parameters for the method 'GetGenres'
type GetGenresOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetGenresOpts - Optional Parameters:
...
*/
func (a *GenresApiService) GetGenres(ctx _context.Context, localVarOptionals *GetGenresOpts) (BaseItemDtoQueryResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
