...
// APIClient manages communication with the Jellyfin API API vv1
...
type APIClient struct {
	...
	AlbumsApi *AlbumsApiService

	ApiKeyApi *ApiKeyApiService

	ArtistsApi *ArtistsApiService
	...
	DisplayPreferencesApi *DisplayPreferencesApiService

	DlnaApi *DlnaApiService

	DlnaServerApi *DlnaServerApiService

	DynamicHlsApi *DynamicHlsApiService

	EnvironmentApi *EnvironmentApiService

	FilterApi *FilterApiService

	GenresApi *GenresApiService

	HlsSegmentApi *HlsSegmentApiService

	ImageApi *ImageApiService

	ImageByNameApi *ImageByNameApiService

	InstantMixApi *InstantMixApiService

	ItemLookupApi *ItemLookupApiService

	ItemRefreshApi *ItemRefreshApiService

	ItemUpdateApi *ItemUpdateApiService

	ItemsApi *ItemsApiService

	LibraryApi *LibraryApiService

	LibraryStructureApi *LibraryStructureApiService

	LiveTvApi *LiveTvApiService

	LocalizationApi *LocalizationApiService

	MediaInfoApi *MediaInfoApiService

	MoviesApi *MoviesApiService

	MusicGenresApi *MusicGenresApiService
	...
	PlaystateApi *PlaystateApiService

	PluginsApi *PluginsApiService

	QuickConnectApi *QuickConnectApiService

	RemoteImageApi *RemoteImageApiService
	...
	StartupApi *StartupApiService

	StudiosApi *StudiosApiService

	SubtitleApi *SubtitleApiService

	SuggestionsApi *SuggestionsApiService

	SyncPlayApi *SyncPlayApiService

	SystemApi *SystemApiService

	TimeSyncApi *TimeSyncApiService

	TrailersApi *TrailersApiService

	TvShowsApi *TvShowsApiService

	UniversalAudioApi *UniversalAudioApiService

	UserApi *UserApiService

	UserLibraryApi *UserLibraryApiService

	UserViewsApi *UserViewsApiService

	VideoAttachmentsApi *VideoAttachmentsApiService

	VideoHlsApi *VideoHlsApiService

	VideosApi *VideosApiService

	YearsApi *YearsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DlnaApi = (*DlnaApiService)(&c.common)
	c.DlnaServerApi = (*DlnaServerApiService)(&c.common)
	...
	c.ImageByNameApi = (*ImageByNameApiService)(&c.common)
	...
	c.VideoHlsApi = (*VideoHlsApiService)(&c.common)
