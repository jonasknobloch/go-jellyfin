...
// GetPersonOpts Optional parameters for the method 'GetPerson'
type GetPersonOpts struct {
 ...
 * @param optional nil or *GetPersonOpts - Optional Parameters:
 * @param "UserId" (optional.Interface of string) -  Optional. Filter by user id, and attach user data.
@return BaseItemDto
*/
func (a *PersonsApiService) GetPerson(ctx _context.Context, name string, localVarOptionals *GetPersonOpts) (BaseItemDto, *_nethttp.Response, error) {
	var (
...
// GetPersonsOpts Optional parameters for the method 'GetPersons'
type GetPersonsOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetPersonsOpts - Optional Parameters:
 ...
 * @param "Filters" (optional.Interface of []ItemFilter) -  Optional. Specify additional filters to apply. This allows multiple, comma delimited. Options: IsFolder, IsNotFolder, IsUnplayed, IsPlayed, IsFavorite, IsResumable, Likes, Dislikes.
...
*/
func (a *PersonsApiService) GetPersons(ctx _context.Context, localVarOptionals *GetPersonsOpts) (BaseItemDtoQueryResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
