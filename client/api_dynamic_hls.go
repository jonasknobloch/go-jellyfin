...
// GetHlsAudioSegmentOpts Optional parameters for the method 'GetHlsAudioSegment'
type GetHlsAudioSegmentOpts struct {
 ...
 * @param optional nil or *GetHlsAudioSegmentOpts - Optional Parameters:
...
@return *os.File
*/
func (a *DynamicHlsApiService) GetHlsAudioSegment(ctx _context.Context, itemId string, playlistId string, segmentId int32, container string, localVarOptionals *GetHlsAudioSegmentOpts) (*os.File, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Audio/{itemId}/hls1/{playlistId}/{segmentId}.{container}"
...
// GetHlsVideoSegmentOpts Optional parameters for the method 'GetHlsVideoSegment'
type GetHlsVideoSegmentOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param segmentId The segment id.
 * @param container The video container. Possible values are: ts, webm, asf, wmv, ogv, mp4, m4v, mkv, mpeg, mpg, avi, 3gp, wmv, wtv, m2ts, mov, iso, flv.
 * @param optional nil or *GetHlsVideoSegmentOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *DynamicHlsApiService) GetHlsVideoSegment(ctx _context.Context, itemId string, playlistId string, segmentId int32, container string, localVarOptionals *GetHlsVideoSegmentOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{itemId}/hls1/{playlistId}/{segmentId}.{container}"
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", _neturl.QueryEscape(parameterToString(itemId, "")) , -1)
...
// GetMasterHlsAudioPlaylistOpts Optional parameters for the method 'GetMasterHlsAudioPlaylist'
type GetMasterHlsAudioPlaylistOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
    ...
    Context optional.Interface
    StreamOptions optional.Interface
    EnableAdaptiveBitrateStreaming optional.Bool
}
 ...
 * @param optional nil or *GetMasterHlsAudioPlaylistOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
 ...
 * @param "Context" (optional.Interface of EncodingContext) -  Optional. The MediaBrowser.Model.Dlna.EncodingContext.
 * @param "StreamOptions" (optional.Interface of map[string]string) -  Optional. The streaming options.
 * @param "EnableAdaptiveBitrateStreaming" (optional.Bool) -  Enable adaptive bitrate streaming.
@return *os.File
*/
func (a *DynamicHlsApiService) GetMasterHlsAudioPlaylist(ctx _context.Context, itemId string, mediaSourceId string, localVarOptionals *GetMasterHlsAudioPlaylistOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Audio/{itemId}/master.m3u8"
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", _neturl.QueryEscape(parameterToString(itemId, "")) , -1)
	...
	if localVarOptionals != nil && localVarOptionals.EnableAdaptiveBitrateStreaming.IsSet() {
		localVarQueryParams.Add("enableAdaptiveBitrateStreaming", parameterToString(localVarOptionals.EnableAdaptiveBitrateStreaming.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
// GetMasterHlsVideoPlaylistOpts Optional parameters for the method 'GetMasterHlsVideoPlaylist'
type GetMasterHlsVideoPlaylistOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param itemId The item id.
 * @param mediaSourceId The media version id, if playing an alternate version.
 * @param optional nil or *GetMasterHlsVideoPlaylistOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *DynamicHlsApiService) GetMasterHlsVideoPlaylist(ctx _context.Context, itemId string, mediaSourceId string, localVarOptionals *GetMasterHlsVideoPlaylistOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{itemId}/master.m3u8"
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", _neturl.QueryEscape(parameterToString(itemId, "")) , -1)
...
// GetVariantHlsAudioPlaylistOpts Optional parameters for the method 'GetVariantHlsAudioPlaylist'
type GetVariantHlsAudioPlaylistOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param itemId The item id.
 * @param optional nil or *GetVariantHlsAudioPlaylistOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *DynamicHlsApiService) GetVariantHlsAudioPlaylist(ctx _context.Context, itemId string, localVarOptionals *GetVariantHlsAudioPlaylistOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Audio/{itemId}/main.m3u8"
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", _neturl.QueryEscape(parameterToString(itemId, "")) , -1)
...
// GetVariantHlsVideoPlaylistOpts Optional parameters for the method 'GetVariantHlsVideoPlaylist'
type GetVariantHlsVideoPlaylistOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param itemId The item id.
 * @param optional nil or *GetVariantHlsVideoPlaylistOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *DynamicHlsApiService) GetVariantHlsVideoPlaylist(ctx _context.Context, itemId string, localVarOptionals *GetVariantHlsVideoPlaylistOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{itemId}/main.m3u8"
	localVarPath = strings.Replace(localVarPath, "{"+"itemId"+"}", _neturl.QueryEscape(parameterToString(itemId, "")) , -1)
...
// HeadMasterHlsAudioPlaylistOpts Optional parameters for the method 'HeadMasterHlsAudioPlaylist'
type HeadMasterHlsAudioPlaylistOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param itemId The item id.
 * @param mediaSourceId The media version id, if playing an alternate version.
 * @param optional nil or *HeadMasterHlsAudioPlaylistOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *DynamicHlsApiService) HeadMasterHlsAudioPlaylist(ctx _context.Context, itemId string, mediaSourceId string, localVarOptionals *HeadMasterHlsAudioPlaylistOpts) (*os.File, *_nethttp.Response, error) {
	var (
...
// HeadMasterHlsVideoPlaylistOpts Optional parameters for the method 'HeadMasterHlsVideoPlaylist'
type HeadMasterHlsVideoPlaylistOpts struct {
    Static optional.Bool
    Params optional.String
    Tag optional.String
    DeviceProfileId optional.String
 ...
 * @param itemId The item id.
 * @param mediaSourceId The media version id, if playing an alternate version.
 * @param optional nil or *HeadMasterHlsVideoPlaylistOpts - Optional Parameters:
 * @param "Static" (optional.Bool) -  Optional. If true, the original file will be streamed statically without any encoding. Use either no url extension or the original file extension. true/false.
 * @param "Params" (optional.String) -  The streaming parameters.
 * @param "Tag" (optional.String) -  The tag.
 * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
...
@return *os.File
*/
func (a *DynamicHlsApiService) HeadMasterHlsVideoPlaylist(ctx _context.Context, itemId string, mediaSourceId string, localVarOptionals *HeadMasterHlsVideoPlaylistOpts) (*os.File, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodHead
		localVarPostBody     interface{}
		localVarFormFileName string
