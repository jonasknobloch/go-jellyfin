...
// GetTrailersOpts Optional parameters for the method 'GetTrailers'
type GetTrailersOpts struct {
 ...
 * @param optional nil or *GetTrailersOpts - Optional Parameters:
...
*/
func (a *TrailersApiService) GetTrailers(ctx _context.Context, localVarOptionals *GetTrailersOpts) (BaseItemDtoQueryResult, *_nethttp.Response, error) {
	var (
